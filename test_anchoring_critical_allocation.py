...
# TODO: Train critical on harsher penalty for p.timeouts
...
def main():
    ...
    # test pretrained off & on, anchored, trained without priority weighting
    # runner.test(
    #     allocator='pretrained',
    #     probability_critical_events=config.normal_priority_job_probability,
    ...
    # test pretrained off & on, anchored double penalty, trained without priority weighting
    # runner.test(
    #     allocator='pretrained',
    #     probability_critical_events=config.normal_priority_job_probability,
